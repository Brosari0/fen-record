...
export const blackTray: any = document.querySelector(".black-tray")
export const whiteTray: any = document.querySelector(".white-tray")
...
export function initPreview() {
  ...
  const squares: any = boardElement.querySelectorAll(`div[data-role]`)
  const board2d = new Array()
